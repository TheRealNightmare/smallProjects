...
//defined height and width of the sdl window
#define WIDTH 1200
#define HEIGHT 600
...
//defined nummber of rays to be simulated
...
void FillRays(SDL_Surface* surface, struct Ray rays[RAYS_NUMBER], Uint32 color, Uint32 blur_color, struct Circle object)
{
  ...
  for(int i=0; i<RAYS_NUMBER; i++)
  {
    ...
    while(!end_of_screen && !object_hit)
    {
      ...
      SDL_Rect ray_point = (SDL_Rect) {x_draw,y_draw,RAYTHICKNESS,RAYTHICKNESS};
      double blur_size = 1.5*RAYTHICKNESS;
